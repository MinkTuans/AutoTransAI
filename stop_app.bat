@echo off
echo Stopping WorkflowVdAi background processes...
powershell -Command "Get-Process -Name python, uvicorn, node, vite -ErrorAction SilentlyContinue | Where-Object {$_.Path -like '*WorkflowVdAi*'} | Stop-Process -Force"
