...
app.options.receive("theme", core.action.options.theme);
app.options.receive("store", core.action.options.store);
app.options.receive("adjust", core.action.options.adjust);
