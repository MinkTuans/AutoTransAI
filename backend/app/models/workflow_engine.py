...
class ProjectGlossary(Base):
    ...
    __table_args__ = (
        UniqueConstraint("project_id", "source_key", name="uq_project_glossary_source_key"),
        UniqueConstraint("project_id", "translation_key", name="uq_project_glossary_translation_key"),
    )
