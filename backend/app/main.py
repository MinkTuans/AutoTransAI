...
from app.api.routes import projects, providers, system, video_translator, storage, apps, video_editor, thumbnail, video_merger, settings as settings_router, ai_catalog
